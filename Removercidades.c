...
int* RemoveCidades(int *Vetor_cidades,int *petala_atual, int Tamanho_Vetor_Cidade,int TamanhoPetala){
    ...
    NovoVetor = (int* ) calloc(Tamanho_Vetor_Cidade - TamanhoPetala + 2, sizeof(int)); /* Novo vetor terá o tamanho do Vetor Cidade diminuido das cidades presente na petala que não são 0 como 0 aparece duas vezes temos que somar 2*/
